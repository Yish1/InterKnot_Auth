...
"}")
        ...
        self.gridLayout_6.addWidget(self.label_8, 9, 0, 1, 2)
        self.checkBox = QtWidgets.QCheckBox(self.groupBox)
        self.checkBox.setObjectName("checkBox")
        self.gridLayout_6.addWidget(self.checkBox, 8, 0, 1, 2)
        ...
        self.gridLayout_6.addWidget(self.checkBox_2, 7, 0, 1, 3)
        ...
        self.gridLayout_6.addWidget(self.lineEdit_4, 0, 1, 1, 2)
    ...
    def retranslateUi(self, sac_settings):
        ...
        self.checkBox.setText(_translate("sac_settings", "通过WebUI共享绳网应用"))
